 ...
 * set up route here
 */
 const createBillingRoute = require('./routes/createBillingRoute');
 const getBillingRoute = require('./routes/getBillingRoute');
 ...
 app.use('/FundAccount', createBillingRoute);
 app.use('/GetBilling', getBillingRoute);
